...
module.exports.routes = {
  ...
  ***************************************************************************/
  ...
  // Don't use the first line, because you're not calling an action. You're just viewing it, so no function is being called. 
 // 'get /articles/list': {view: 'list'},

 // - When I go to /articles/list 
 //- go to the ArticlesController
 //- run the list function
  'get /articles/list':'ArticlesController.list',
  
  'get /articles/add':'ArticlesController.add',

  //'get /articles/create':'ArticlesController.list'
